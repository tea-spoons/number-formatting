...
namespace TeaSpoons.NumberFormatting.Editor.Tests
{
    ...
    public class LongFormattingTest
    {
        [TestCase(0, "0")]
        [TestCase(10, "10")]
        [TestCase(100, "100")]
        ...
        [TestCase(-10, "-10")]
        [TestCase(-1000000, "-1.000.000")]
        public void ExactLongFormatterWithDotAsThousandsSeperator(long input, string output)
        {
            var formatter = new ExactLongFormatter('.');
        ...
        [TestCase(-999999, "-1M")]
        [TestCase(-1000000, "-1M")]
        public void SuffixLongFormatterForAmount(long input, string output)
        {
